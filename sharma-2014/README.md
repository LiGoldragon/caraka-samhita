...
The page-level transcription preserves real Devanagari for chapters whose underlying source pages had usable Sanskrit text — predominantly Sūtrasthāna chapters 1 to ~17 (book pp. 1-140 of the OCR). From book p. 141 onwards, dense Sanskrit verses are marked `[Devanagari unclear: …]` in the page transcription and dropped silently in the markdown per [CONVENTIONS.md](CONVENTIONS.md). The English paragraphs stand alone in those chapters. Reconstructing the Sanskrit for the placeholder-only chapters would require either a Devanagari-capable OCR pass over the source PDF (`~/primary/repos/library/en/caraka/caraka-samhita-priya-vrat-sharma.pdf`) or cross-referencing against an alternate Cakrapāṇi-commentary edition such as the Sharma/Dash 7-volume set. (The free-path 1922 Nirṇaya-Sāgara PDF was tested 2026-05-09 and rejected; see `~/primary/repos/caraka-samhita/notes/translation-sources.md`.)
